...
The macOS app supports more providers (Grok, Command Code, GitHub Copilot,
Perplexity). Gemini API, Ollama (local runtime and cloud), GLM and OpenCode Go are ported (W-07); the others are not yet.
